...
urlpatterns = [
    ...
    path('api/agent/<str:agent_name>/submit_llm_response/', views.submit_llm_response, name='submit_llm_response'),
    path('api/llm_queue/<int:llm_id>/update/', views.update_llm_request, name='update_llm_request'),
]
